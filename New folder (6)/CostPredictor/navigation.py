...
def create_navigation_frame(root, logo_image, toggle_theme, select_frame):
    ...
    return home_button, reformat_button, split_data_button, unit_prices_button, concrete_mix_button, excel_processing_button, quantity_calc_button, theme_toggle_switch
